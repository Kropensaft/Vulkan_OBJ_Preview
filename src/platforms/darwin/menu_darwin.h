/**
 * @file menu_darwin.h
 * @brief Native macOS menu bar integration using Objective-C++.
 */
 ...
 * @param file_callback The function to be called when the "Open" menu item is
 * clicked.
 * @param wireframeCallback The function to toggle wireframe.
 * @param zoomInCallback Callback to zoom in.
 * @param zoomOutCallback Callback to zoom out.
 * @param switchLSCallback Callback to switch lighting.
 * @param zoomSensCallback Callback for the zoom slider.
 */
